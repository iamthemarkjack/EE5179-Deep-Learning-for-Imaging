...
def main():
    ...
    parser.add_argument("--save-dir", type=str, default="outputs_bidir")
    ...
    model = RNNClassifier(input_size=28, hidden_size=args.hidden_size, cell_type="LSTM", bidirectional=True, num_classes=10).to(device)
    ...
    torch.save(model.state_dict(), os.path.join(args.save_dir, "mnist_rnn_bidir.pth"))
