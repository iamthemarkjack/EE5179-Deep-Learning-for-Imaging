...
def train(model, device, train_loader, optimizer, criterion, epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        # reshape: (batch, 1, 28, 28) -> sequence (batch, 28, 28) using rows
...
def main():
    ...
    parser.add_argument("--save-dir", type=str, default="outputs_vanilla")
    ...
    model = RNNClassifier(input_size=28, hidden_size=args.hidden_size, cell_type="RNN", bidirectional=False, num_classes=10).to(device)
    ...
    # Save model
    torch.save(model.state_dict(), os.path.join(args.save_dir, "mnist_rnn_vanilla.pth"))
